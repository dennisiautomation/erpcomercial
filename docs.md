...
**Nenhuma loja é migrada**: as 20 configurações seguem onde estavam.
...
⚠️ **DEPLOY PENDENTE.** Tem migration (`2026_09_04_140000`) e **nenhuma loja muda de comportamento**
até alguém escolher a quarta opção — Dennis decidiu entregar com todas desligadas.

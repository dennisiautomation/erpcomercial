...
1. **Dennis decidir em quais empresas ligar.** Hoje só 3 têm vendedor: ia365 (1), MISS MERLINDA (4)
   e N S BORBA (5 vendedores). A chave nasce desligada em todas.

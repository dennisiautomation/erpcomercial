...
- Editável por **dono/admin**. O gerente entra nesta tela desde 02/09, mas esta opção mexe no
  acesso de outro usuário: vê o switch travado com o motivo escrito.

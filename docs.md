...
|---|---|---|
| `main` = `origin/main` = **produção** | `cca0a88` | tudo do dia 04/09: RBAC do gerente, fix da roda do mouse e a 4ª regra de split |
| `estoque-roda-do-mouse` (pushada) | `36dc693` | o fix da roda do mouse sozinho — já contido na `main` |
| `feat/split-acrescimo-por-parte` (pushada) | `cca0a88` | a 4ª regra — já contido na `main` |

🔑 **A regra da casa é `main` == produção**, e no fim de 04/09 as três referências coincidem em
`cca0a88` — conferido arquivo a arquivo contra o container. As duas branches ficam no remoto como
rastro das entregas; podem ser apagadas.

...
| `troca-item-sem-cupom` | rodada 1 **EM PRODUÇÃO 09/09 ~14:05**; rodada 2 (peça sem venda) **DEPLOY PENDENTE** — seção 9w | crédito da troca no split + peça sem cupom no F6 (9w), migration `2026_09_09_180000` |

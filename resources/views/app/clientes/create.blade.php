...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0 small">Siga os passos para cadastrar um novo cliente</p>
    </div>
...
<form method="POST" action="{{ route('app.clientes.store') }}" id="formCliente" novalidate>
    @csrf
    <input type="hidden" name="tipo_pessoa" id="tipo_pessoa" value="{{ old('tipo_pessoa', '') }}">

    <div class="wizard-card">

        {{-- ═══════════════════════════════════════════════════
             STEP 1 — Quem e seu cliente?
             ═══════════════════════════════════════════════════ --}}
        <div class="wizard-step active" data-step="1">
            <h5 class="step-title">Quem e seu cliente?</h5>
            <p class="step-subtitle">Escolha o tipo de pessoa para continuar</p>

            <div class="row g-4 justify-content-center">
                <div class="col-md-6">
                    <div class="wizard-option {{ old('tipo_pessoa') === 'pf' ? 'selected' : '' }}" data-type="pf" onclick="selectType('pf')">
                ...
                <div class="col-md-6">
                    <div class="wizard-option {{ old('tipo_pessoa') === 'pj' ? 'selected' : '' }}" data-type="pj" onclick="selectType('pj')">
                        <div class="text-center p-4 p-md-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        <input type="text" name="cpf_cnpj" id="cpf_cnpj"
                               ...
                               value="{{ old('cpf_cnpj') }}"
                               placeholder="000.000.000-00" @if($exigeDoc) required @endif>
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" name="nome_razao_social" id="nome_razao_social"
                           ...
                           value="{{ old('nome_razao_social') }}" required>
        ...
        <div class="wizard-step" data-step="4">
            <h5 class="step-title">Contato</h5>
            <p class="step-subtitle">Como voce se comunica com esse cliente?</p>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="limite_credito" id="limite_credito"
                               ...
                               value="{{ old('limite_credito', '0.00') }}" step="0.01" min="0">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="observacoes" id="observacoes"
                              ...
                              rows="2" placeholder="Informacoes adicionais sobre o cliente...">{{ old('observacoes') }}</textarea>
                    @error('observacoes')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    @if($errors->any() && old('tipo_pessoa'))
        selectedType = '{{ old("tipo_pessoa") }}';
        document.getElementById('tipo_pessoa').value = selectedType;
        updatePJFields();
    ...
    window.goToStep = function(n, skipValidation) {
        ...
        // Validate current step before advancing (unless skipping)
    ...
    function validateStep(step) {
        ...
        // Steps 3 and 4: no required fields, allow advancing
        return true;
    }

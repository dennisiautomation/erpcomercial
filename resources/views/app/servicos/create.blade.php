...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="bi bi-tools me-2"></i>Novo Servico</h4>
        <p class="text-muted mb-0 small">Siga os passos para cadastrar um novo servico</p>
    </div>
...
<div class="wizard-progress" id="wizardProgress">
    <div class="step-item">
        <div class="step-circle active" data-step="1">
            1
            <span class="step-label">Dados do Servico</span>
        </div>
    </div>
    ...
    <div class="step-item">
        <div class="step-circle" data-step="2">
            2
            <span class="step-label">Dados Fiscais</span>
        </div>
    </div>
</div>

<form method="POST" action="{{ route('app.servicos.store') }}" id="formServico" novalidate>
    @csrf
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" name="descricao" id="descricao"
                           ...
                           placeholder="Ex: Manutencao preventiva, Instalacao de software...">
                    @error('descricao')
                ...
                <div class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="codigo_lc116" id="codigo_lc116"
                               ...
                               value="{{ old('codigo_lc116') }}" placeholder="Ex: 14.01">
                        @error('codigo_lc116')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    @if($errors->any())
        @if($errors->has('descricao') || $errors->has('valor_padrao'))
            goToStep(1, true);
        @else
            goToStep(2, true);
        @endif
    ...
    function validateStep(step) {
        ...
        if (step === 1) {
            ...
            if (!descricao) { showError('errorDescricao', 'Informe a descricao do servico'); valid = false; }
            return valid;
        }
        return true;
    }

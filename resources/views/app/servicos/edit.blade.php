...
@section('content')
<x-erp.page-header title="Editar Servico" icon="pencil-square">
    <a href="{{ route('app.servicos.index') }}" class="btn btn-erp-outline"><i class="bi bi-arrow-left me-1"></i>Voltar</a>
</x-erp.page-header>

<form method="POST" action="{{ route('app.servicos.update', $servico) }}" class="erp-form">
    @csrf
    @method('PUT')
    ...
    <div class="d-flex gap-2 mb-4">
        <button type="submit" class="btn btn-erp-primary"><i class="bi bi-check-lg me-1"></i>Atualizar Servico</button>

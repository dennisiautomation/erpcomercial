...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="bi bi-truck me-2"></i>Novo Fornecedor</h4>
        <p class="text-muted mb-0 small">Siga os passos para cadastrar um novo fornecedor</p>
    </div>
...
<div class="wizard-progress" id="wizardProgress">
    <div class="step-item">
        <div class="step-circle active" data-step="1">
            1
            <span class="step-label">Identificacao</span>
        </div>
    </div>
...
<form method="POST" action="{{ route('app.fornecedores.store') }}" id="formFornecedor" novalidate>
    ...
    <div class="wizard-card">
        ...
        <div class="wizard-step active" data-step="1">
            ...
            <p class="step-subtitle">Informe o CNPJ para buscar automaticamente os dados</p>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" name="razao_social" id="razao_social"
                           ...
                           placeholder="Razao social ou nome completo" required>
                    @error('razao_social')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="cep" id="cep"
                               ...
                               value="{{ old('cep') }}" maxlength="9" placeholder="00000-000" data-cep>
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="logradouro" id="logradouro"
                           ...
                           value="{{ old('logradouro') }}" placeholder="Rua, Avenida, etc.">
                    @error('logradouro')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="complemento" id="complemento"
                           ...
                           value="{{ old('complemento') }}" placeholder="Sala, Bloco, etc.">
                    @error('complemento')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="contato_representante" id="contato_representante"
                               ...
                               value="{{ old('contato_representante') }}"
                ...
                <div class="col-12">
                    ...
                    <textarea name="condicoes_comerciais" id="condicoes_comerciais"
                              ...
                              rows="3" placeholder="30/60/90 dias boleto">{{ old('condicoes_comerciais') }}</textarea>
                    @error('condicoes_comerciais')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateStep(step) {
        ...
        if (step === 1) {
            ...
            if (!razao) {
                showError('errorRazaoSocial', 'Informe a Razao Social');
                valid = false;
            }
            return valid;
        }

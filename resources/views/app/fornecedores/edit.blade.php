...
@section('content')
<x-erp.page-header title="Editar Fornecedor" subtitle="{{ $fornecedore->razao_social }}" icon="pencil-square">
    <a href="{{ route('app.fornecedores.show', $fornecedore) }}" class="btn btn-erp-outline"><i class="bi bi-eye me-1"></i>Visualizar</a>
    <a href="{{ route('app.fornecedores.index') }}" class="btn btn-erp-outline"><i class="bi bi-arrow-left me-1"></i>Voltar</a>
</x-erp.page-header>

<form method="POST" action="{{ route('app.fornecedores.update', $fornecedore) }}" class="erp-form" id="formFornecedor" novalidate>
    @csrf
    @method('PUT')
    ...
    <div class="d-flex gap-2 mb-4">
        <button type="submit" class="btn btn-erp-primary"><i class="bi bi-check-lg me-1"></i>Atualizar Fornecedor</button>

...
@section('content')
<x-erp.page-header title="Editar Funcionario" icon="pencil-square">
    <a href="{{ route('app.funcionarios.index') }}" class="btn btn-erp-outline"><i class="bi bi-arrow-left me-1"></i>Voltar</a>
</x-erp.page-header>

<form method="POST" action="{{ route('app.funcionarios.update', $funcionario) }}" class="erp-form">
    @csrf
    @method('PUT')
    ...
    <div class="d-flex gap-2 mb-4">
        <button type="submit" class="btn btn-erp-primary"><i class="bi bi-check-lg me-1"></i>Atualizar Funcionario</button>

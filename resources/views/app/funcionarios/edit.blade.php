...
<style>
    ...
    .perfil-option .perfil-icon { font-size: 2rem; color: var(--primary); margin-bottom: 0.5rem; }
    .perfil-option h6 { font-weight: 700; margin-bottom: 0.15rem; color: var(--text-primary); }
    .perfil-option p { font-size: 0.78rem; color: var(--text-muted); margin-bottom: 0; }
</style>
@endpush
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="bi bi-pencil-square me-2"></i>Editar Funcionario</h4>
        <p class="text-muted mb-0 small">{{ $funcionario->name }}</p>
    </div>
...
<form method="POST" action="{{ route('app.funcionarios.update', $funcionario) }}" id="formFuncionario" novalidate>
    @csrf
    @method('PUT')
    <input type="hidden" name="perfil" id="perfil" value="{{ old('perfil', $funcionario->perfil?->value) }}">
    ...
    <div class="wizard-card">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" id="name"
                           ...
                           value="{{ old('name', $funcionario->name) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="cpf" id="cpf"
                           ...
                           value="{{ old('cpf', $funcionario->cpf) }}" maxlength="14" placeholder="000.000.000-00" data-mask="cpf">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="telefone" id="telefone"
                               ...
                               value="{{ old('telefone', $funcionario->telefone) }}" placeholder="(00) 00000-0000" data-mask="telefone">
                    </div>
        ...
        <div class="wizard-step" data-step="2">
            ...
            <p class="step-subtitle">Credenciais e perfil de acesso</p>
            ...
            <div class="row g-3">
                <div class="col-6 col-md-4">
                    <div class="perfil-option {{ old('perfil', $funcionario->perfil?->value) === 'gerente' ? 'selected' : '' }}" data-perfil="gerente" onclick="selectPerfil('gerente')">
                ...
                <div class="col-6 col-md-4">
                    <div class="perfil-option {{ old('perfil', $funcionario->perfil?->value) === 'vendedor' ? 'selected' : '' }}" data-perfil="vendedor" onclick="selectPerfil('vendedor')">
                ...
                <div class="col-6 col-md-4">
                    <div class="perfil-option {{ old('perfil', $funcionario->perfil?->value) === 'caixa' ? 'selected' : '' }}" data-perfil="caixa" onclick="selectPerfil('caixa')">
                ...
                <div class="col-6 col-md-4">
                    <div class="perfil-option {{ old('perfil', $funcionario->perfil?->value) === 'financeiro' ? 'selected' : '' }}" data-perfil="financeiro" onclick="selectPerfil('financeiro')">
                ...
                <div class="col-6 col-md-4">
                    <div class="perfil-option {{ old('perfil', $funcionario->perfil?->value) === 'consulta' ? 'selected' : '' }}" data-perfil="consulta" onclick="selectPerfil('consulta')">
        ...
        <div class="wizard-step" data-step="3">
            ...
            <p class="step-subtitle">Comissao, status e unidades de acesso</p>
            ...
            <div class="row g-3">
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        <input type="number" name="comissao_percentual" id="comissao_percentual"
                               ...
                               value="{{ old('comissao_percentual', $funcionario->comissao_percentual) }}" step="0.01" min="0" max="100">
                ...
                <div class="col-12 mt-3">
                    ...
                    @else
                        @php $funcUnidades = $funcionario->unidades->pluck('id')->toArray(); @endphp
                        <div class="row g-2">
        ...
        <div class="wizard-nav">
            ...
            <button type="submit" class="btn btn-success rounded-pill" id="btnSalvar" style="display:none;">
                <i class="bi bi-check-lg me-1"></i> Atualizar Funcionario
            </button>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateStep(step) {
        ...
        if (step === 2) {
            ...
            if (password && password.length < 6) { showError('errorPassword', 'A senha deve ter pelo menos 6 caracteres'); valid = false; }

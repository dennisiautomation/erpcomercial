...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-person-plus-fill me-2"></i>Novo Funcionário</h4>
    <a href="{{ route('app.funcionarios.index') }}" class="btn btn-outline-secondary">
        <i class="bi bi-arrow-left me-1"></i> Voltar
    </a>
</div>

<form method="POST" action="{{ route('app.funcionarios.store') }}">
    @csrf
    ...
    <div class="d-flex justify-content-end gap-2">
        ...
        <button type="submit" class="btn btn-primary">
            <i class="bi bi-check-lg me-1"></i> Salvar Funcionário
        </button>
    </div>
</form>
@endsection

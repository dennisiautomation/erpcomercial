...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-cash-stack me-2"></i>Contas a Receber</h4>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr class="{{ $conta->status === 'pendente' && $conta->vencimento->isPast() ? 'table-danger' : '' }}">
                    ...
                    <td>{{ Str::limit($conta->descricao, 40) }}</td>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="{{ route('app.contas-receber.show', $conta) }}" class="btn btn-sm btn-outline-secondary" title="Ver">
                                <i class="bi bi-eye"></i>
                            </a>
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center text-muted py-4">Nenhuma conta encontrada.</td>
                </tr>
                @endforelse
            </tbody>
        </table>

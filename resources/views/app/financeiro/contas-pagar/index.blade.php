...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="bi bi-wallet2 me-2"></i>Contas a Pagar</h4>
        <p class="text-muted mb-0 small">Gerencie despesas, fornecedores e pagamentos</p>
    </div>
                ...
                <tr class="{{ $isOverdue ? 'border-start border-danger border-3' : '' }}">
                    ...
                    <td class="text-center pe-3">
                        <div class="d-flex gap-1 justify-content-center">
                            <a href="{{ route('app.contas-pagar.show', $conta) }}" class="btn btn-sm btn-outline-primary" title="Detalhes">
                                <i class="bi bi-eye"></i>
                            </a>

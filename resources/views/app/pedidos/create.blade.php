...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="bi bi-cart-plus me-2"></i>Novo Pedido</h4>
    ...
    <div class="row g-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="observacoes_externas" class="form-control" rows="3"
                                  placeholder="Instrucoes de entrega, observacoes gerais...">{{ old('observacoes_externas') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="mt-3 d-flex gap-2 justify-content-end">
                <a href="{{ route('app.pedidos.index') }}" class="btn btn-outline-secondary btn-lg">
                    Cancelar
                </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addItemRow(data = null) {
        ...
        updateEmptyState();
        calcularTotais();
        if (!data) row.querySelector('.produto-busca').focus();
    }

...
@section('content')
<x-erp.page-header title="Nova Movimentacao de Estoque" subtitle="Registre entradas, ajustes, perdas ou bonificacoes" icon="plus-circle">
...
<div class="row">
    <div class="col-lg-8">
        <form method="POST" action="{{ route('app.movimentacoes.store') }}">
            ...
            <x-erp.form-section title="Produto e Tipo" icon="box-seam">
                <div class="mb-4">
            ...
            <x-erp.form-section title="Quantidade e Custo" icon="calculator">
                <div class="row mb-4">
                    <div class="col-md-6">

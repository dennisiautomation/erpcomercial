        ...
        <div class="tab-pane fade show active" id="geral" role="tabpanel">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    @if($produto->foto)
                        <div class="form-text">
                            <i class="bi bi-image me-1"></i>Foto atual: {{ basename($produto->foto) }}
                        </div>
                    @endif
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="preco_venda" id="preco_venda" class="form-control fw-bold @error('preco_venda') is-invalid @enderror" value="{{ old('preco_venda', $produto->preco_venda) }}" step="0.01" min="0" required>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="origem" id="origem" class="form-select @error('origem') is-invalid @enderror">
                        ...
                        <option value="0" {{ old('origem', $produto->origem) === '0' ? 'selected' : '' }}>0 - Nacional, exceto as indicadas nos codigos 3, 4, 5 e 8</option>
                        <option value="1" {{ old('origem', $produto->origem) === '1' ? 'selected' : '' }}>1 - Estrangeira - Importacao direta</option>
                        <option value="2" {{ old('origem', $produto->origem) === '2' ? 'selected' : '' }}>2 - Estrangeira - Adquirida no mercado interno</option>
                        <option value="3" {{ old('origem', $produto->origem) === '3' ? 'selected' : '' }}>3 - Nacional - Conteudo de importacao superior a 40% e inferior ou igual a 70%</option>
                        <option value="4" {{ old('origem', $produto->origem) === '4' ? 'selected' : '' }}>4 - Nacional - Processos produtivos basicos</option>
                        <option value="5" {{ old('origem', $produto->origem) === '5' ? 'selected' : '' }}>5 - Nacional - Conteudo de importacao inferior ou igual a 40%</option>
                        <option value="6" {{ old('origem', $produto->origem) === '6' ? 'selected' : '' }}>6 - Estrangeira - Importacao direta, sem similar nacional</option>
                        <option value="7" {{ old('origem', $produto->origem) === '7' ? 'selected' : '' }}>7 - Estrangeira - Adquirida no mercado interno, sem similar nacional</option>
                        <option value="8" {{ old('origem', $produto->origem) === '8' ? 'selected' : '' }}>8 - Nacional - Conteudo de importacao superior a 70%</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="cfop" id="cfop" class="form-control @error('cfop') is-invalid @enderror" value="{{ old('cfop', $produto->cfop) }}" maxlength="4" placeholder="5102">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="cst_csosn" id="cst_csosn" class="form-control @error('cst_csosn') is-invalid @enderror" value="{{ old('cst_csosn', $produto->cst_csosn) }}" maxlength="4" placeholder="102">

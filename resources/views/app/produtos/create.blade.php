                        ...
                        <div class="border rounded p-3 bg-light-subtle">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">R$</span>
                                        <input type="text" inputmode="numeric" data-mask="money" name="preco_atacado" id="preco_atacado" class="form-control @error('preco_atacado') is-invalid @enderror" value="{{ old('preco_atacado') }}" placeholder="sem preço de atacado">
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="altura_cm" id="altura_cm" class="form-control @error('altura_cm') is-invalid @enderror" value="{{ old('altura_cm', '') }}" step="0.1" min="0" placeholder="pacote padrão">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="largura_cm" id="largura_cm" class="form-control @error('largura_cm') is-invalid @enderror" value="{{ old('largura_cm', '') }}" step="0.1" min="0" placeholder="pacote padrão">
                            <span class="input-group-text">cm</span>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="comprimento_cm" id="comprimento_cm" class="form-control @error('comprimento_cm') is-invalid @enderror" value="{{ old('comprimento_cm', '') }}" step="0.1" min="0" placeholder="pacote padrão">
                            <span class="input-group-text">cm</span>
            ...
            <div class="card-body p-4">
                ...
                @else
                    ...
                    <div class="row g-3">
                        ...
                        @php($reformaProduto = \App\Services\FocusNFe\ReformaTributariaCalculator::obrigatoriaParaEmpresa(auth()->user()->empresa) || ($configFiscal->ibs_ativo ?? false) || ($configFiscal->cbs_ativo ?? false) || ($configFiscal->is_ativo ?? false))
                        @if($reformaProduto)
                            <div class="col-12 mt-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="cst_ibs_cbs" maxlength="3" class="form-control" placeholder="000 (padrão)" value="{{ old('cst_ibs_cbs') }}">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Classificação (cClassTrib)</label>
                                        <input type="text" name="classificacao_ibs" maxlength="10" class="form-control" placeholder="000001 (padrão)" value="{{ old('classificacao_ibs') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">IBS (%)</label>
                                        <input type="number" name="ibs_aliquota" step="0.0001" min="0" max="100" class="form-control" placeholder="0,1" value="{{ old('ibs_aliquota') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">CBS (%)</label>
                                        <input type="number" name="cbs_aliquota" step="0.0001" min="0" max="100" class="form-control" placeholder="0,9" value="{{ old('cbs_aliquota') }}">
                                    </div>

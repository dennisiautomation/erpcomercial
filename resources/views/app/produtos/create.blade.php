...
<form method="POST" action="{{ route('app.produtos.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="tab-pane fade show active" id="geral" role="tabpanel">
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="descricao_detalhada" id="descricao_detalhada" class="form-control @error('descricao_detalhada') is-invalid @enderror" rows="2">{{ old('descricao_detalhada') }}</textarea>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="preco_venda" id="preco_venda" class="form-control @error('preco_venda') is-invalid @enderror" value="{{ old('preco_venda', '0.00') }}" step="0.01" min="0" required>
                    @error('preco_venda')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="origem" id="origem" class="form-select @error('origem') is-invalid @enderror">
                        ...
                        <option value="1" {{ old('origem') === '1' ? 'selected' : '' }}>1 - Estrangeira (importação direta)</option>
                        <option value="2" {{ old('origem') === '2' ? 'selected' : '' }}>2 - Estrangeira (mercado interno)</option>
                        <option value="3" {{ old('origem') === '3' ? 'selected' : '' }}>3 - Nacional (import. 40-70%)</option>
                        <option value="4" {{ old('origem') === '4' ? 'selected' : '' }}>4 - Nacional (proc. básicos)</option>
                        <option value="5" {{ old('origem') === '5' ? 'selected' : '' }}>5 - Nacional (import. < 40%)</option>
                        <option value="6" {{ old('origem') === '6' ? 'selected' : '' }}>6 - Estrangeira (sem similar)</option>
                        <option value="7" {{ old('origem') === '7' ? 'selected' : '' }}>7 - Estrangeira (c/ similar)</option>
                        <option value="8" {{ old('origem') === '8' ? 'selected' : '' }}>8 - Nacional (import. > 70%)</option>
                    </select>
                    @error('origem')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="cfop" id="cfop" class="form-control @error('cfop') is-invalid @enderror" value="{{ old('cfop') }}" maxlength="10" placeholder="5102">
                    @error('cfop')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="cst_csosn" id="cst_csosn" class="form-control @error('cst_csosn') is-invalid @enderror" value="{{ old('cst_csosn') }}" maxlength="10">
                    @error('cst_csosn')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>

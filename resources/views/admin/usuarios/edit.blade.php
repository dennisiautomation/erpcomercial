        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check form-switch mt-1 {{ old('is_admin', $usuario->is_admin) ? '' : 'd-none' }}" id="wrap_pode_ver_financeiro">
                        ...
                        <input class="form-check-input" type="checkbox" id="pode_ver_financeiro" name="pode_ver_financeiro" value="1"
                               {{ old('pode_ver_financeiro', $usuario->pode_ver_financeiro) ? 'checked' : '' }}>
